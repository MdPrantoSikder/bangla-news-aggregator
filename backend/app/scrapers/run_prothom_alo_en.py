"""
Runner for the Prothom Alo English scraper.
Run with:  python -m app.scrapers.run_prothom_alo_en
"""
import time
from app.services.categories import extract_category
from app.scrapers.prothom_alo_en import (
    fetch_homepage_html,
...
PROTHOM_ALO_EN_SOURCE_ID = 10
DELAY_BETWEEN_ARTICLES_SECONDS = 1.0


def run() -> None:
    print("=" * 60)
    print("Prothom Alo English Scraper Run")
    print("=" * 60)
        ...
        for index, headline_info in enumerate(headlines, start=1):
            ...
            try:
                ...
                article_in = ArticleCreate(
                    source_id=PROTHOM_ALO_EN_SOURCE_ID,
                    url=article_url,
